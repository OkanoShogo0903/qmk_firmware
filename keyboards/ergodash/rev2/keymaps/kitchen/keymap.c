...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( 
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______,                          RAISE, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, JA_ENUN, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_GRV,           KC_SPC,  _______, LOWER,          ADJUST,  RAISE, LOWER,            KC_LEFT, KC_DOWN, KC_UP,   KC_ENT   \
  ),
   ...
   * |  F11 |  F1  |  F2  |  F3  |  F4  |  F5  |      |                    |      |  F6  |  F7  |  F8  |  F9  |  F10 |  F12 |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |      | Reset|RGB ON|  MODE|  HUE-|  HUE+|      |                    |      |      |  7   |  8   |  9   |      |      |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |      |  SAT-|  SAT+|  VAL-|  VAL+|      |                           |      |      |  4   |  5   |  6   |      |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |                    |      |      |  1   |  2   |  3   |      |      |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |      ||||||||      |      |      ||||||||      |      |      ||||||||      |      |      |      |
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TRNS, RESET  , RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, KC_TRNS,                        KC_TRNS, KC_TRNS,  KC_7,    KC_8,    KC_9, KC_TRNS, KC_TRNS, \
    KC_TRNS, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS,  KC_4,    KC_5,    KC_6, KC_TRNS, KC_TRNS, \
